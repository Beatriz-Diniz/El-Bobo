...
public class LetraPorLetra : MonoBehaviour
{
    ...
    {   
        int _indiceColor = Dialogo.transform.GetComponent<SistemaDialogo>()._indiceColor;
        Debug.Log(_indiceColor);
        _texto.color = Dialogo.transform.GetComponent<SistemaDialogo>().color[_indiceColor];
